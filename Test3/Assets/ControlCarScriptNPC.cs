...
public class ControlCarScriptNPC : MonoBehaviour
{
    ...
    public float TimeTargetUpdate = 0;// Через какое время бот обновит цель
    ...
    {// Тут идёт запись данных колёс
        ...
        rb.centerOfMass = CentrOfMass.localPosition;// Задаём центр тяжести
    }
        ...
        {// если переменная не пуста 
            ...
            {// если время обновлять цель, то
                ...
                for (int T = 0; T < Targets.Length; T++)
                {
                    ...
                    {// если до новой цели ближе чем до старой
